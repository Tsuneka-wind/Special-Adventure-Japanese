 ...
 * @param bgBitmapEquip
 * @text 装备场景背景
 * @desc 装备场景的背景位图文件 img/pictures.
 * @default 
 * 
 * @param bgBitmapStatus
 * @text 状态场景背景
 * @desc 状态场景背景图片img/pictures.
 * @default 
 * 
 ...
 * @param bgBitmapFile
 * @text 存档背景图片
 * @desc 存档/load scene. put at img/pictures.
 * @default 
 * 
 * @param bgBitmapGameEnd
 * @text 游戏结束背景图片
 * @desc 游戏结束背景图片 img/pictures.
 * @default 
 * 
 * @param maxColsMenu
 * @text 菜单窗口中的最大列
 ...
 * ---------------------------------------------------------------
 * 此插件不提供插件命令。
 * 与软件自带的AltMenuscreen区别如下：
 * - 窗口在所有菜单场景中都是透明的。
 * - 它可以在菜单中为每个场景设置背景图。
 * - 图片设置立绘
 * ---------------------------------------------------------------
 * 角色备注：
 * <stand_picture:filename> 在菜单上设置立绘图片。
 * 将文件放在img/pictures.
 *
 * 立绘照片的首选尺寸:
